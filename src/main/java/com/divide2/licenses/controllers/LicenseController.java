...
public class LicenseController {
    ...
    public License getLicenses( @PathVariable("organizationId") String organizationId,
        ...
        logger.debug("Entering the license-services-controllers");
        logger.debug("Found tmx-correlation-id in license-services-controllers: {} ", request.getHeader("tmx-correlation-id"));
